...
[cx_Freeze](https://cx-freeze.readthedocs.io/en/latest/script.html) can turn a python application to an executalbe that works, but cannot make a single-file executable.
